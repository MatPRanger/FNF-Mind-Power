...
class PlayState extends MusicBeatState
{
	...
	public static var ratingStuff:Array<Dynamic> = [
		['Ouch', 0.2], //From 0% to 19%
		['Bad', 0.4], //From 20% to 39%
		['Bad', 0.5], //From 40% to 49%
		['Decent', 0.6], //From 50% to 59%
	...
	override public function create()
	{
		...
		healthBar = new FlxBar(healthBarBG.x + 10, healthBarBG.y + 15, RIGHT_TO_LEFT, Std.int(healthBarBG.width - 25), Std.int(healthBarBG.height - 9), this,
			'health', 0, 2);
	...
	public function RecalculateRating(badHit:Bool = false) {
		...
		if(ret != FunkinLua.Function_Stop)
		{
			...
			// Rating FC
			ratingFC = "";
			if (sicks > 0) ratingFC = "Full Combo";
			if (goods > 0) ratingFC = "Full Combo";
