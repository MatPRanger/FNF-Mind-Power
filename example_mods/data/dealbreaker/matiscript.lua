...
leftMissOffsets = {'67', '104'}    -- use as required
downMissOffsets = {'54', '181'}
upMissOffsets = {'35', '165'}
rightMissOffsets = {'113', '20'}
...
idle_xml_name = 'Mati Idle0'
left_xml_name = 'Mati Left0'
down_xml_name = 'Mati Down0'
up_xml_name = 'Mati Up0'
right_xml_name = 'Mati Right0'

left_miss_xml_name = 'Mati LeftMiss0'   -- use as required
down_miss_xml_name = 'Mati DownMiss0'
up_miss_xml_name = 'Mati UpMiss0'
right_miss_xml_name = 'Mati RightMiss0'
...
name_of_character_xml = 'Mati'
name_of_character = 'Mati'
charNote = 'mati'
